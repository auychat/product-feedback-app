...
const Button = ({ onClick, className, btnColor, children }: ButtonProps) => {
  const btnClasses: { [key: string]: string } = {
    "purple-light": "bg-purple-light hover:bg-[#C75AF6] text-[#F2F4FE] active:bg-purple-light transition-all duration-150 ease-in-out",
    "blue-primary": "bg-blue-primary hover:bg-[#7C91F9] text-[#F2F4FE] active:bg-blue-primary transition-all duration-150 ease-in-out",
    "blue-dark": "bg-blue-dark hover:bg-[#656EA3] text-[#F2F4FE] active:bg-blue-dark transition-all duration-150 ease-in-out",
    "danger": "bg-[#D73737] hover:bg-[#E98888] text-[#F2F4FE] active:bg-[#D73737] transition-all duration-150 ease-in-out",
    "goback-dark":
