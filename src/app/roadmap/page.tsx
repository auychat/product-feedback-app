...
const Roadmap = () => {
  ...
  return (
    <div className="bg-gray-background">
      <div className="max-w-[1110px] min-h-[1024px] mx-auto flex flex-col gap-12 pt-[94px] pb-[130px] xs:pb-[88px] xs:min-w-[375px] xs:max-w-[480px] xs:pt-0 xs:gap-0">
        {/* Header */}
        <div className="bg-blue-secondary h-[113px] w-full rounded-[10px] flex items-center xs:rounded-none xs:h-[100px] xs:px-6">
        ...
        {/* Click Tab */}
        <div className="xs:flex items-center justify-between min-w-[327px] w-full h-[60px] mx-auto ">
